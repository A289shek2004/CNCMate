...
# This explains why the model made predictions.
...
# Used to detect abnormal readings even without labels.
...
# 📌 Compare anomalies vs actual failures
pd.crosstab(df["failure_label"], df["anomaly_label"])

# ⭐ MODEL 3 (Optional) — Tool Life Prediction

# Useful bonus model if you want: “When will the tool wear out?”
...
# Predict tool wear at next cycle:
